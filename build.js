    ...
    <div data-elementor-type="wp-page" data-elementor-id="320" class="elementor elementor-320" data-elementor-post-type="page">
        ...
        <script>
            ...
            window.addEventListener('DOMContentLoaded', () => {
                ...
                function startAutoScroll() {
                    ...
                    autoScrollTimer = setInterval(() => {
                        if(carouselTrack.scrollLeft + carouselTrack.clientWidth >= carouselTrack.scrollWidth - 10) {
                            ...
                            carouselTrack.scrollBy({ left: 1, behavior: 'instant' });
                        }
                    }, 45); // Slower crawl: 1px every 45ms (approx 22px per second)
                }
                ...
                // Initial start
                setTimeout(startAutoScroll, 2000); // Wait for page load
